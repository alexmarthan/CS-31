...
int main() {
        ...
        assert(locateMaximum(array, 4) == 3);
        assert(locateMaximum(array, 1) == 0);
        assert(locateMaximum(array, 2) == 1);
        assert(hasNoDuplicates(array, 5) == 1);
        assert(hasNoDuplicates(array2, 5) == 0);
        assert(hasNoDuplicates(array2, 3) == 0);
        assert(hasNoDuplicates(array2, 1) == 1);
        assert(countXPairs(array3, 5, 2) == 1);
        assert(countXPairs(array3, 5, 15) == 0);
        assert(countXPairs(array3, 5, 3) == 2);
        assert(findSecondToLastOccurrence(array2,5,"Dennis") == 0);
        assert(findSecondToLastOccurrence(array,5,"Dennis") == -1);
        assert(findSecondToLastOccurrence(array3,4,"0") == -1);
        assert(findSecondToLastOccurrence(array3,5,"") == -1);
        assert(findSecondToLastOccurrence(array4,5,"1") == 2);
        assert(findSecondToLastOccurrence(array4,4,"1") == 1);
        assert(findSecondToLastOccurrence(array4,-1,"1") == -1);
        assert(findSecondToLastOccurrence(array,5,"Nat") == -1);
        assert(countPunctuation(array,5) == 0);
        assert(countPunctuation(array,5) == 0);
        assert(countPunctuation(punctArr,4) == 5);
        assert(moveToEnd(array, 5, 3) == 3);
        assert(moveToEnd(array, 5, 6) == -1);
        assert(flipAround(array,5) == 2);
        assert(flipAround(array,6) == 3);
        assert(flipAround(punctArr,4) == 2);
        assert(flipAround(array,2) == 1);
